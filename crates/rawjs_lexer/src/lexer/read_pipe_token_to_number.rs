impl Lexer {
    pub(super) fn read_pipe_token(&mut self) -> TokenKind {
        self.advance();
        if self.consume_if('|') {
            if self.consume_if('=') {
                TokenKind::OrAssign
...
impl Lexer {
    pub(super) fn read_caret_token(&mut self) -> TokenKind {
        self.advance();
        if self.consume_if('=') {
...
impl Lexer {
    pub(super) fn read_bang_token(&mut self) -> TokenKind {
        self.advance();
        if self.consume_if('=') {
            if self.consume_if('=') {
...
impl Lexer {
    pub(super) fn read_equal_token(&mut self) -> TokenKind {
        self.advance();
        if self.consume_if('=') {
            if self.consume_if('=') {
...
impl Lexer {
    pub(super) fn read_less_token(&mut self) -> TokenKind {
        self.advance();
        if self.consume_if('<') {
            if self.consume_if('=') {
...
impl Lexer {
    pub(super) fn read_greater_token(&mut self) -> TokenKind {
        self.advance();
        if self.consume_if('>') {
            if self.consume_if('>') {
                if self.consume_if('=') {
...
impl Lexer {
    pub(super) fn read_number(&mut self) -> Result<TokenKind> {
