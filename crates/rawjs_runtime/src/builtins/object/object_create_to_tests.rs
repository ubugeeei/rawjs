pub(super) fn object_create(heap: &mut Heap, _this: &JsValue, args: &[JsValue]) -> Result<JsValue> {
...
mod tests {
    use super::*;
    #[test]
    pub(super) fn test_object_has_own_property_builtin() {
    ...
    #[test]
    pub(super) fn test_object_keys_builtin() {
        let mut heap = Heap::new();
        let mut obj = JsObject::ordinary();
    ...
    #[test]
    pub(super) fn test_object_define_property_builtin() {
        let mut heap = Heap::new();
    ...
    #[test]
    pub(super) fn test_object_get_prototype_of_and_prevent_extensions() {
        let mut heap = Heap::new();
    ...
    #[test]
    pub(super) fn test_object_set_prototype_of_builtin() {
        let mut heap = Heap::new();
        let target = heap.alloc(JsObject::ordinary());
        let proto = heap.alloc(JsObject::ordinary());
    ...
    #[test]
    pub(super) fn test_object_get_own_property_descriptor_builtin() {
        let mut heap = Heap::new();
        let target = heap.alloc(JsObject::ordinary());
