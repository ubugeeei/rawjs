pub(super) fn map_keys(heap: &mut Heap, this: &JsValue, _args: &[JsValue]) -> Result<JsValue> {
    match this {
        JsValue::Object(ptr) => {
            let obj = ptr.borrow();
            match &obj.internal {
...
pub(super) fn map_values(heap: &mut Heap, this: &JsValue, _args: &[JsValue]) -> Result<JsValue> {
    match this {
        JsValue::Object(ptr) => {
            let obj = ptr.borrow();
            match &obj.internal {
...
pub(super) fn map_entries(heap: &mut Heap, this: &JsValue, _args: &[JsValue]) -> Result<JsValue> {
    match this {
        JsValue::Object(ptr) => {
            let obj = ptr.borrow();
            match &obj.internal {
...
mod tests {
    ...
    #[test]
    pub(super) fn test_map_overwrite() {
        let mut heap = Heap::new();
        let map_val = map_constructor(&mut heap, &JsValue::Undefined, &[]).unwrap();
        map_set(
            &mut heap,
    ...
    #[test]
    pub(super) fn test_map_keys_values_entries() {
        let mut heap = Heap::new();
        let map_val = map_constructor(&mut heap, &JsValue::Undefined, &[]).unwrap();
        map_set(
            &mut heap,
    ...
    #[test]
    pub(super) fn test_same_value_zero_nan() {
