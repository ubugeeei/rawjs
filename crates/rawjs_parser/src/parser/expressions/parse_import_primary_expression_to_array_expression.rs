impl Parser {
    pub(super) fn parse_import_primary_expression(&mut self) -> Result<Expression> {
...
impl Parser {
    pub(super) fn parse_import_expression(&mut self) -> Result<Expression> {
...
impl Parser {
    pub(super) fn parse_import_meta_expression(&mut self) -> Result<Expression> {
        let loc = self.location();
        self.expect(&TokenKind::Import)?;
