impl Parser {
    pub(super) fn parse_assignment_operator(&mut self) -> Result<AssignmentOp> {
...
impl Parser {
    pub(super) fn parse_nullish_coalescing_expression(&mut self) -> Result<Expression> {
        let loc = self.location();
...
impl Parser {
    pub(super) fn parse_logical_or_expression(&mut self) -> Result<Expression> {
        let loc = self.location();
...
impl Parser {
    pub(super) fn parse_logical_and_expression(&mut self) -> Result<Expression> {
        let loc = self.location();
...
impl Parser {
    pub(super) fn parse_bitwise_or_expression(&mut self) -> Result<Expression> {
        let loc = self.location();
...
impl Parser {
    pub(super) fn parse_bitwise_xor_expression(&mut self) -> Result<Expression> {
        let loc = self.location();
...
impl Parser {
    pub(super) fn parse_bitwise_and_expression(&mut self) -> Result<Expression> {
        let loc = self.location();
