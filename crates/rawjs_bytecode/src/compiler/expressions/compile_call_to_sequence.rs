impl Compiler {
    pub(super) fn compile_call(&mut self, call: &CallExpression) -> Result<()> {
...
impl Compiler {
    pub(super) fn compile_new(&mut self, new_expr: &NewExpression) -> Result<()> {
...
impl Compiler {
    pub(super) fn compile_member_load(&mut self, member: &MemberExpression) -> Result<()> {
        self.compile_expression(&member.object)?;
        if member.optional {
...
impl Compiler {
    pub(super) fn compile_sequence(&mut self, seq: &SequenceExpression) -> Result<()> {
