impl Compiler {
    pub(super) fn compile_switch(&mut self, sw: &SwitchStatement) -> Result<()> {
...
impl Compiler {
    pub(super) fn compile_throw(&mut self, th: &ThrowStatement) -> Result<()> {
...
impl Compiler {
    pub(super) fn compile_try(&mut self, try_stmt: &TryStatement) -> Result<()> {
