...
pub(crate) const JIT_THRESHOLD: u32 = 10;
...
pub struct Vm {
    ...
    pub(crate) globals: HashMap<String, JsValue>,
    ...
    pub(crate) jit_cache: HashMap<usize, JitFunction>,
    /// Per-chunk invocation counts used to decide when to JIT.
    pub(crate) execution_counts: HashMap<usize, u32>,
    ...
    pub(crate) module_cache: HashMap<String, GcPtr<JsObject>>,
