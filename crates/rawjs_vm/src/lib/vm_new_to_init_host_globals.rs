...
impl Vm {
    pub(super) fn init_core_globals(&mut self) -> GcPtr<JsObject> {
...
impl Vm {
    pub(super) fn init_function_and_object_globals(
        &mut self,
...
impl Vm {
    pub(super) fn init_host_globals(&mut self, obj_proto: &GcPtr<JsObject>) {
        use rawjs_runtime::builtins;
